#Author: David Holmes
#A Dungeons and Dragons Character Creation Program

#Most recent update: able to write character bio into new text file; fixed starting health bug; implementing directories
#Current Goals: clean up code for readability; add subclasses from Xanathar's; include skill proficiencies;
#expand random name bank to include names from different races; allow for name change in random to prevent overwriting previous
...
#A reusable function for promting additional information
def helper(topic):
...
def main():
    ...
    while restart == True:
        ...
        print()
        print()
        print("Welcome to the D&D character-building program!")
        print()
        ...
        if boolean(random_response) == True:
            ...
            #print("initial boost:    ", auto_stats.assigned_list)
            ...
            if auto_race == "Half-Elf":
                ...
                while remaining_bonus > 0:
                    ...
                    if (auto_stats.assigned_list[main_stat_index] % 2) == 1 and main_stat != 'CHA':
                        ...
                        #print("Adding to Main:", auto_stats.assigned_list, sep='')
                    ...
                    if (auto_stats.assigned_list[2] % 2) == 1:
                        ...
                        #print("Adding to CON:", auto_stats.assigned_list)
...
#Make it choose which even at random#
            ...
            #Optional info about D&D
            dnd_info = helper("D&D")
            if boolean(dnd_info) == True:
                add_info.dnd()
            print()
